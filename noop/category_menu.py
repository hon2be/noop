...
MENU_ITEMS = [("랜덤","random"),("한국어","korean"),("영어","english"),("개발상식","dev"),("시사상식","news"),("넌센스","nonsense")]
...
def _draw_count(stdscr, count: int, max_count: int):
    ...
    try:
        ...
        stdscr.addstr(center_y, cx + len(label_l),         num_str,  curses.A_REVERSE | curses.A_BOLD)
